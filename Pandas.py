...
column_owner_count_audi = car_data_audi['Owner_Count']
column_price_audi = car_data_audi['Price']
column_mileage_audi = car_data_audi['Mileage']
...
plt.scatter(column_mileage_audi,column_price_audi, s=10,cmap='coolwarm',zorder=1)
